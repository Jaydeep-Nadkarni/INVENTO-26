...
const teamsData = [
  ...
  },
  {
    ...
    members: [
      ...
      { name: 'Akhilesh Joshi', role: 'Content Strategist', phone: '+91 54321 09876', img: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Vikram', socials: { instagram: 'https://www.instagram.com/invento_jce/', linkedin: '#', whatsapp: '#' } },
    ]
  },
  {
    id: 'media',
    name: 'Media',
    members: [
      { name: 'Akhilesh Joshi', role: 'Press Officer', phone: '+91 43210 98765', img: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Anjali', socials: { instagram: 'https://www.instagram.com/invento_jce/', linkedin: '#', whatsapp: '#' } },
      { name: 'Akhilesh Joshi', role: 'Visual Comms', phone: '+91 32109 87654', img: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Rahul', socials: { instagram: 'https://www.instagram.com/invento_jce/', linkedin: '#', whatsapp: '#' } },
    ]
  },
  {
    id: 'cultural',
  ...
  },
  {
    ...
    name: 'CDC',
    members: [
      { name: 'Akhilesh Joshi', role: 'Development Lead', phone: '+91 99887 76655', img: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Arjun', socials: { instagram: 'https://www.instagram.com/invento_jce/', linkedin: '#', whatsapp: '#' } },
    ]
  },
  {
    id: 'wec',
    name: 'WEC',
    members: [
      { name: 'Akhilesh Joshi', role: 'Empowerment Lead', phone: '+91 88776 65544', img: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Kavya', socials: { instagram: 'https://www.instagram.com/invento_jce/', linkedin: '#', whatsapp: '#' } },
    ]
  },
  {
    id: 'fine_arts',
