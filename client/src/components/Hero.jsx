    ...
    <div className="relative w-full max-w-[90%] h-screen mx-auto flex items-center justify-center overflow-hidden pt-20 md:pt-24">
      ...
      <div className="z-20 transform flex flex-col items-center">
        <div className="relative">
          {/* Main Text */}
          <h1 className="text-7xl md:text-9xl font-black tracking-tighter text-red-700 drop-shadow-2xl" 
              style={{ 
      ...
      <div className="absolute top-24 left-8 md:top-28 md:left-16 z-10 hidden md:block">
      ...
      <div className="absolute top-24 left-48 md:top-28 md:left-60 z-10 hidden md:block">
        <div className="relative w-40">
          <img src={pin} alt="pin" className="absolute -top-4 left-1/2 transform -translate-x-1/2 w-8 z-20" />
      ...
      {/* Top Right - Year 2026 */}
      <div className="absolute top-28 right-12 md:top-32 md:right-24 z-10 hidden md:block">
