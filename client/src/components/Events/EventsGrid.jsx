                                        ...
                                        {confirmation.whatsappLink && (
                                            <div className="space-y-3">
                                                ...
                                                <a
                                                    ...
                                                    className="block w-full py-4 bg-[#25D366] text-white font-black uppercase tracking-widest hover:scale-105 transition-all shadow-xl rounded flex items-center justify-center gap-3"
                                                >
