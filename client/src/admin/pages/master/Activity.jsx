                ...
                <div className="max-w-7xl mx-auto">
                        ...
                        <div className="flex items-center gap-4 w-full md:w-auto">
                            <div className="relative w-full md:w-64">
                                <select 
                                    ...
                                    className="appearance-none w-full bg-white border border-gray-200 px-4 py-2 pr-10 text-xs font-bold uppercase tracking-widest rounded focus:outline-none focus:ring-1 focus:ring-blue-500 cursor-pointer text-gray-700"
                                >
                    ...
                    <div className="space-y-4">
                        {filteredLogs.map((log) => (
                            <div key={log.id} className="bg-white border border-gray-200 p-5 rounded-md flex flex-col md:flex-row md:items-center justify-between gap-6 hover:bg-gray-50 transition-all shadow-sm">
                                <div className="flex items-center gap-4 text-left">
                                    <div className="w-10 h-10 flex items-center justify-center bg-gray-50 border border-gray-200 rounded text-gray-400">
                                        <Terminal className="w-4 h-4" />
                                    </div>
                                    <div>
                                        <div className="flex flex-wrap items-center gap-2 mb-1">
                                            <span className="text-sm font-bold text-gray-900">{log.admin}</span>
                                            <span className="text-[10px] bg-gray-100 text-gray-500 px-2 py-0.5 rounded font-black uppercase tracking-tight">{log.team}</span>
                                        </div>
                                ...
                                <div className="flex flex-col items-start md:items-end text-right md:border-l border-gray-200 md:pl-8">
                    ...
                    <div className="mt-12 p-12 bg-white border border-dashed border-gray-200 rounded-md text-center shadow-sm">
                        <p className="text-xs text-gray-400 font-bold uppercase tracking-[0.4em]">End of current session</p>
                    </div>
                </div>
            </main>
        </div>
